...
**Do not maintain anything in here. Do not treat it as current.** Where it disagrees with [`docs/`](../docs/), `docs/` is right — the archive still describes seven deployables, Nx, an `api-gateway`, Jenkins, Istio, and other decisions that were later reversed.
